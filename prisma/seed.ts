...
const categories = [
  ...
  },
  {
    ...
    description:
      "Fast-moving consumer goods for wholesalers, retailers, hospitality and corporate accounts — food staples, household care and toiletries by the carton.",
  },
  {
...
const products: Seed[] = [
  ...
  // --- FMCG & Household
  {
    slug: "long-grain-rice-50kg",
    name: "Long Grain Parboiled Rice — 50kg Bag",
    sku: "SUEZ-FMC-RICE50",
    category: "fmcg",
    price: N(78000),
    compareAtPrice: N(84000),
    costPrice: N(69500),
    unit: "per bag",
    stock: 420,
    lowStockThreshold: 80,
    ...
    shortDescription: "Destoned long grain parboiled rice in a 50kg woven polypropylene bag.",
    description:
      "Double-sifted, destoned long grain parboiled rice supplied direct from the mill in sealed 50kg bags. Consistent grain length and low broken content, suited to catering, hospitality and institutional feeding. Trailer-load pricing available from 200 bags.",
  },
  {
    slug: "vegetable-cooking-oil-25l",
    name: "Refined Vegetable Cooking Oil — 25 Litre Keg",
    sku: "SUEZ-FMC-OIL25",
    category: "fmcg",
    price: N(58000),
    costPrice: N(51000),
    ...
    shortDescription: "Cholesterol-free refined, bleached and deodorised vegetable oil in a sealed 25L keg.",
    description:
      "Fully refined vegetable cooking oil, fortified with Vitamin A and NAFDAC registered. Supplied in tamper-evident 25 litre kegs for kitchens, bakeries, restaurants and camp catering. Batch and expiry printed on every keg.",
  },
  {
    slug: "granulated-sugar-50kg",
    name: "Granulated White Sugar — 50kg Bag",
    sku: "SUEZ-FMC-SUG50",
    category: "fmcg",
    price: N(72000),
    costPrice: N(64000),
    ...
    warehouse: "Abuja FMCG Warehouse",
    weightKg: 50,
    imageUrl: "https://images.unsplash.com/photo-1562245376-3f9dae9f0e73?w=800&auto=format&fit=crop&q=80",
    shortDescription: "Refined granulated white sugar, mill-packed in 50kg bags.",
    description:
      "ICUMSA 45 refined granulated white sugar supplied in mill-sealed 50kg bags. Free-flowing, uniform crystal size, suitable for beverage production, bakeries and bulk catering.",
  },
  {
    slug: "detergent-powder-carton",
    name: "Detergent Powder — Carton of 24 × 900g",
    sku: "SUEZ-FMC-DET24",
    category: "fmcg",
    price: N(46000),
    costPrice: N(39500),
    ...
    warehouse: "Abuja FMCG Warehouse",
    weightKg: 21.6,
    imageUrl: "https://images.unsplash.com/photo-1593095948071-474c5cc2989d?w=800&auto=format&fit=crop&q=80",
    shortDescription: "Shrink-wrapped carton of 24 × 900g high-foam laundry detergent sachets.",
    description:
      "High-foam multi-purpose laundry detergent powder for hand and machine wash, supplied by the carton for retail resale, housekeeping and facility contracts. Trade discounts apply from 20 cartons.",
  },
  {
    slug: "toilet-tissue-carton",
    name: "Toilet Tissue — Carton of 48 Rolls (2-Ply)",
    sku: "SUEZ-FMC-TIS48",
    category: "fmcg",
    price: N(19500),
    costPrice: N(15800),
    ...
    shortDescription: "Carton of 48 two-ply embossed toilet rolls for offices, hotels and site facilities.",
    description:
      "Soft two-ply embossed virgin pulp toilet tissue, individually wrapped and packed 48 rolls to the carton. Standard supply line for office facility contracts, guest houses and construction camps.",
  },
  {
    slug: "bar-soap-carton",
    name: "Multipurpose Bar Soap — Carton of 30 × 1kg",
    sku: "SUEZ-FMC-SOAP30",
    category: "fmcg",
    price: N(24500),
    costPrice: N(20000),
    ...
    warehouse: "Abuja FMCG Warehouse",
    weightKg: 30,
    imageUrl: "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?w=800&auto=format&fit=crop&q=80",
    shortDescription: "Carton of 30 one-kilogram multipurpose laundry bars for household and institutional use.",
    description:
      "Long-lasting multipurpose bar soap for laundry and general cleaning, packed 30 bars to the carton. A steady mover for retail distributors, camps and housekeeping contracts.",
  },
];
